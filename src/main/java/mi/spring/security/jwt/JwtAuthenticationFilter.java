...
import mi.spring.security.UserDetailsImpl;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    @Override
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication outhResult) throws IOException{
        log.info("로그인 성공 및 JWT 생성");

        String username = ((UserDetailsImpl)outhResult.getPrincipal()).getUsername();
        UserRoleEnum role = ((UserDetailsImpl)outhResult.getPrincipal()).getRole();
